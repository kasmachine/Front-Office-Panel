...
export function getInitialReceiptData(): ReceiptSubstituteData {
  ...
  return {
    ...
    endDate: dateStr,
    items: [
      { id: 'rec-1', date: dateStr, description: 'ค่าน้ำมันรถรับส่งลูกค้า', amount: 350, remark: 'ไม่มีใบเสร็จ' },
      { id: 'rec-2', date: dateStr, description: 'ค่าอุปกรณ์สำนักงาน', amount: 120, remark: 'ซื้อจากตลาดสด' },
